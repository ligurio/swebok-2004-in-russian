## 5. Сопровождение программного обеспечения (Software Maintenance по SWEBOK)
...
2.2.2 Проблемы кадрового обеспечения<sup>3</sup> (Staffing)
