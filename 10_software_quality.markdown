...
https://web.archive.org/web/20140217034144im_/http://swebok.sorlik.ru/images/quality_area_small.jpg
...
1. Планирование процессов для получения требуемого продукта (см., например, области знаний “Проектирование” и “Конструирование”).
