## 8. Процесс программной инженерии (Software Engineering Process по SWEBOK)
...
1.3 Модели реализации и изменения процесса (Models for Process Implementation
and Change)
...
4. Измерения в отношении процессов и продуктов (Process and Product
Measurement)
...
4.2<sup>6</sup> Измерения в отношении программных продуктов (Software Product
Measurement)
