## 9. Инструменты и методы программной инженерии (Software Engineering Tools and Methods по SWEBOK)
...
1.6 Инструменты конфигурационного управления (Software Configuration Management
Tools)
...
1.7 Инструменты управления инженерной деятельностью (Software Engineering
Management Tools)
...
1.10 Дополнительные аспекты инструментального обеспечения (Miscellaneous Tool
Issues)
...
ПО, воздействие этих методов все же ограничено. Так называемые формальны методы
